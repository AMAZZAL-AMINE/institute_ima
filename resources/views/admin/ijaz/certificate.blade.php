...
@section("content")
    <div class="container">
        <div class="certificate" id="printableArea">
            ...
            <div class="certificate-footer">
                Institut IPHEC de Formation Privée /cite Salam a coté de Barid Bank et en face de Faculté des lettres et sciences humaines et Lycée Ibn Maja AGADIR/MAROC
                Email : iphecinstitut@gmail.com/ FIX: 0528238703 / Tel : 0629732615 /0661586669 RC: 42323 Patente : 67501736 ID: 42712084 ICE:002385241000091
            </div>
        </div>
      <div class="text-center mt-3 mb-5">
        <button onclick="printDiv('printableArea')" class="btn btn-primary"><i class="fa fa-print" aria-hidden="true"></i> Print Certificate</button>
      </div>
    </div>

        ...
        <div class="container">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Toutes les statistiques du mois de <span
                            class="text-danger">{{ $month }}/{{ $year }}</span> </h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Nombre Total de nouveaux étudiants ce mois-ci <span
                            class="text-danger">{{ $month }}/{{ $year }}</span> </h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive table-bordered">
